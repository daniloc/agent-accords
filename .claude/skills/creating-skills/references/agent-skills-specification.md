---
source-url: https://agentskills.io/specification.md
captured: 2026-02-21
update-instructions: Re-fetch from source-url and replace the body content below. Update the captured date to the current date.
---
